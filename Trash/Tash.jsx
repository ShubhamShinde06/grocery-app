...
const ProductUpdate = () => {
  ...
  const { error, isLoading, productGet, productPut, productSingleGet, Data } =
    useProductStore(); // get-product details API
  const { categoryGet, Data: categoryData } = useCategoryStore(); // categoryGet details API
  const { subcategoryGet, Data: subcategoryData } = subcategoryStore(); // SubcategoryGet details API

  const [ids, setID] = useState("");
  const { user } = useAuthStore(); // user get ID API
